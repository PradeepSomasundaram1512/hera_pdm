...
## N. Citations
25, all verified (docs/literature/reference_verification.csv).

## O. Reproducibility
All numbers generated as macros from results/ (validator check 9); commands in README; coding matrix and search logs in docs/literature/; repository public at https://github.com/PradeepSomasundaram1512/hera_pdm (cited in the paper).
