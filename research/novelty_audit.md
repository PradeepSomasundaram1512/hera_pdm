...
* References extended from 15 to 25; all ten additions verified against Crossref DOI records, the JMLR page or the NeurIPS proceedings page, and cited only for what their abstracts state (research/reference_verification.csv).
