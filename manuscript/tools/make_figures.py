...
Fig. 1  architecture (drawn programmatically)          figures/fig_architecture.pdf
Fig. 2  unsafe-decision vs. escalation trade-off       figures/fig_tradeoff.pdf
Supplementary: RUL trajectories                       figures/fig_trajectories.pdf
Supplementary: SHAP importance                         figures/fig_shap.pdf
...
def fig1():
    ...
    fig.savefig(FIG / "fig_architecture.pdf", bbox_inches="tight", pad_inches=0.01)
    plt.close(fig)
...
def fig_traj():
    ...
    fig.savefig(FIG / "fig_trajectories.pdf", bbox_inches="tight", pad_inches=0.01)
    plt.close(fig)
...
def fig_shap():
    ...
    fig.savefig(FIG / "fig_shap.pdf", bbox_inches="tight", pad_inches=0.01)
    plt.close(fig)
