"""Automated pre-submission checks for manuscript/icaiet2027/main.tex.
...
def main():
    ...
    # 9: regenerate macros from results and compare with manuscript/icaiet2027/numbers.tex
    before = (P / "numbers.tex").read_text()
    subprocess.run([sys.executable, str(ROOT / "manuscript/tools/make_tables.py")], check=True, capture_output=True)
