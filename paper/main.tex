...
Alarm-timing guarantee needed & Conformal risk control with $n\ge(1{-}\varepsilon)/(\varepsilon{-}\pi)$ units & bearings ($\approx$12 units): premature \fePremCrcTen\%/\xjPremCrcTen\%; trucks (1000): late \flHeBigLate\% at target 10\% \\
